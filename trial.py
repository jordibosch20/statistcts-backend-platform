...
sns.swarmplot(x="posicion", y="bateo", data=datos,
              color='black', alpha=0.5, ax=ax)

# plt.show()

print(pg.normality(data=datos, dv='bateo', group='posicion'))

print(pg.anova(data=datos, dv='bateo', between='posicion', detailed=True))
